      ...
      <div className="flex items-start gap-2.5 px-3 py-2.5">
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <button
            ...
            style={{ color: expanded ? ACCENT : "#cbd5e1", backgroundColor: expanded ? "rgba(37,99,235,0.08)" : "transparent" }}
          >
          ...
          {canEdit && !editingTitle && (
            <>
              <button onClick={(e) => { e.stopPropagation(); setEditingTitle(true); }} className="btn-jelly w-5 h-5 flex items-center justify-center rounded-md text-gray-300 hover:text-blue-500 transition-colors">
                <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                </svg>
              </button>
              <button onClick={(e) => { e.stopPropagation(); onDelete(task.id); }} className="btn-jelly w-5 h-5 flex items-center justify-center rounded-md text-gray-300 hover:text-red-400 transition-colors">
                <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
